...
def on_user_joins(m):
	...
	if m.content_type == 'new_chat_participant':
		if m.new_chat_participant.id == bot.get_me().id:
			...
			groupid = m.chat.id
			bot.send_message(112256892, "# DEBUG # " + "112256892" + str(H) + "(" + str(112256892) + ")", parse_mode="HTML")
...
def yes(m):
	...
	bot.send_message(112256892, str(user)  + " had Problems in setting up." , parse_mode="Markdown")
